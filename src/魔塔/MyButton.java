...
//      setBorderPainted(false);
        ...
        setBackground(null);
        setBackground(new Color(118,238,0));//设置背景色
        setForeground(Color.GREEN);//设置前景色
        setFont(new  java.awt.Font("微软雅黑",  1,  20)); //设置字体样式
...
//                  Color.decode("#FFFFFF"), Color.decode("#D6E5F5"));
    ...
    private static void drawButtonBackground(Graphics2D g2, MyButton myButton,
        ...
        RoundRectangle2D.Float r2d = new RoundRectangle2D.Float(0, 0,
                myButton.getWidth() - 1, myButton.getHeight() - 1, 10, 10);
        ...
        // 渐变二段
        g2.setPaint(new GradientPaint(1, myButton.getHeight() / 3, c3, 1, myButton
                .getHeight(), c4));
        g2.fillRoundRect(2, myButton.getHeight() / 3, myButton.getWidth() - 5,
        myButton.getHeight() / 3 * 2 - 1, 10, 10);

//      g2.dispose();

    }

    private static void drawButtonPressBackground(Graphics2D g2, MyButton myButton,
            Color c1, Color c2, Color c3, Color c4) {
        ...
        g2.setPaint(new GradientPaint(1, myButton.getHeight() / 3, c3, 1, myButton
                .getHeight(), c4));
        g2.fillRect(2, myButton.getHeight() / 3, myButton.getWidth() - 5,
                myButton.getHeight() / 3 * 2 - 1);
